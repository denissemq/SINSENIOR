...
<div class="container">
    <h1>Nuevo Cancha</h1><br/><br/>
    <form:form action="new" method="post" commandName="cancha" cssClass="form-horizontal">
        <div class="row">
        ...
        <div class="actions" style="margin-left: 160px;">
            ...
            <a style="margin-left: 5px;" href="<c:url value='/pages/canchas/index'/>">Cancelar</a>
        </div>                
    </form:form>
</div>

...
<div class="container">
    <h1>Editar inmueble</h1><br/><br/>
    <form:form action="editcomenta" method="post" commandName="inmuebles" cssClass="form-horizontal">
        <div class="row">
        ...
        <div class="actions" style="margin-left: 160px;">
            ...
            <a style="margin-left: 5px;" href="<c:url value='/pages/inmuebles/indexcomenta'/>">Cancelar</a>
        </div>
    </form:form>
</div>
...
<div class="container">
    ...
    <form:form action="new" method="post" commandName="inmuebles" cssClass="form-horizontal" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                   <p>
                    <form:input path="imagen1" type="file"/>
                </p>
                </div>
            </div> 
            <div class="control-group">
                ...
                <div class="controls">
                   <p>
                    <form:input path="imagen2" type="file"/>
                </p>
                </div>
            </div> 
            <div class="control-group">
                ...
                <div class="controls">
                   <p>
                    <form:input path="imagen3" type="file"/>
                </p>
                </div>
            </div> 
